...
function ValidationPage() {
  ...
  function isValid() {
    ...
    if (username.length < 5) {
      submittedErrors.usernameError =
        "user name should have more than 5 charackters";
    }
    if (password.length < 8) {
      submittedErrors.passwordError =
        "password should have at least 8 charackters";
    }
    ...
    <div className="signupFrm">
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div className="btnClass">
          <button className="submitBtn" onClick={alertBtn}>
            {" "}
            Submit{" "}
          </button>
          <button className="submitBtnReset" onClick={resetBtn}>
            {" "}
            Reset{" "}
          </button>
        </div>
